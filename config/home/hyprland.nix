...
in with lib; {
  wayland.windowManager.hyprland = {
    ...
    in concatStrings [ ''
      ...
      exec-once = swayidle -w timeout 3600 'swaylock -f' timeout 3900 'hyprctl dispatch dpms off' resume 'hyprctl dispatch dpms on' before-sleep 'swaylock -f -c 000000'
      dwindle {
        pseudotile = true
        preserve_split = true
      }
      ...
      bind = ${modifier},Return,exec,thunar
